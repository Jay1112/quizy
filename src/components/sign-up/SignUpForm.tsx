...
function SignUpForm() {
  ...
  return (
    <form onSubmit={handleFormSubmission} className="max-w-[325px] md:max-w-[500px] w-full">
      ...
      <p>Already have an Account ? do <Link to={'/sign-in/'}><span className="text-indigo-500">sign-in</span></Link></p>
    </form>
  );
}
